...
The overview of our proposed SSKGQA is depicted in this chart. Given a question __q__, we assume the topic entity of __q__ has been obtained by preprocessing. Then the answer to __q__ is generated by the following steps. 

**Step 1**： the semantic structure of __q__ is predicted by a novel Structure-BERT classifier. For the example in the above, __q__ is a 2-hop question and the classifier predicts its semantic structure as __SS2__. 
