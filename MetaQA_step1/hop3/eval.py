...
def get_input_id():
    ...
    dev_sentences, dev_labels, test_entity_mention_id = get_data("data/metaQA_classification_3hops_test.txt")
...
def TE(model, validation_dataloader):
    ...
    fw=open("wrong_sentence_id_hop3_in_struture_BERT.txt","w",encoding="utf-8")
