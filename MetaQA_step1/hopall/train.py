...
MAX_LEN=15
"""
reference: https://medium.com/@aniruddha.choudhury94/part-2-bert-fine-tuning-tutorial-with-pytorch-for-text-classification-on-the-corpus-of-linguistic-18057ce330e1
pretraind_model: https://huggingface.co/transformers/pretrained_models.html
there are many retrained models such as: bert-large-uncased,bert-base-multilingual-uncased,bert-base-cased-finetuned-mrpc
...
def get_input_id():
    ...
    dev_sentences, dev_labels,test_entity_mention_id = get_data("data/metaQA_classification_test.txt")
