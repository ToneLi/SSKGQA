...
def get_input_id():
    ...
    dev_sentences, dev_labels,test_entity_mention_id = get_data("data/metaQA_classification_2hops_test.txt")
...
if __name__=="__main__":
    ...
    optimizer = AdamW(model.parameters(), lr=5e-8, eps=1e-8)  # args.adam_epsilon  - default is 1e-8. )  5e-5
